package com.tinyapps7.clockphotoframe.stickerview;
...
public abstract class StickerView extends FrameLayout{
    ...
    private void init(Context context){
        ...
        this.iv_scale.setImageResource(R.mipmap.zoominout);
        this.iv_delete.setImageResource(R.mipmap.remove);
        this.iv_flip.setImageResource(R.mipmap.flip);
